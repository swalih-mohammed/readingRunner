...
namespace HyperCasual.Runner
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private bool m_isPlayerRunning;
        ...
        // sound from animation 
        void FootStepEvent ( ){
            Debug.Log("foot step event");
        }
        ...
        public void FallDown()
        {
             if (m_Animator != null) {
            //  m_Animator.SetBool("FreeFall", true);
            m_Animator.SetBool("FallBack", true);
            Debug.Log("Falling player controller");
             }

        }
        public void IsWaving()
        {
             if (m_Animator != null) { 
             m_Animator.SetBool("Victory", true);
             Debug.Log("victory player controller");
             }
        ...
        public void isRunning()
        {
             if (m_Animator != null) {
                ...
                m_Animator.SetBool("FreeFall", false);
                m_Animator.SetBool("Victory", false);
                m_Animator.SetBool("FallBack", false);
        ...
        {
            m_HasInput = false;
            // Debug.Log("Cancellig movement, player controller");
        }
