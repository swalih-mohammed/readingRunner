...
namespace HyperCasual.Runner
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        [SerializeField] Material skyboxBlue; 
        ...
        public List<Object> usedQustions = new List<Object>();

        [SerializeField] List<Spawnable> m_ActiveSpawnables = new List<Spawnable>();
        ...
        public static void LoadLevel(LevelDefinition levelDefinition, ref GameObject levelGameObject)
        {
            ...
            // initiate a en empty list for rand question 
             List<int> usedQustions = new List<int>();
              int StartingPosition = Random.Range(30, 50);  
              int randGatePos = 0; 
              int collectableLen = levelDefinition.Collectables.Count;;
              int obstucleLen = levelDefinition.Obstacles.Count;
              float levelLen = levelDefinition.LevelLength;
              int gateCount =  (int) levelLen / 70 ;
