...
namespace HyperCasual.Runner
{
    ...
    public class LevelManager : MonoBehaviour
    {
        ...
        /// </summary>
        /// 
        List<int> usedSounds = new List<int>();
        int soundRound; 
        public void AddUsedSound(int sound)
        {
            usedSounds.Add(sound);
        }
        public bool CheckUsedSound(int sound)
        {
            if(usedSounds.Contains(sound)){
                return true;
            } else {
                return false;
            }
        }
        public int CheckUsedSoundLen()
        {
         return usedSounds.Count;
        }
        public void ClearUsedSound()
        {
            usedSounds.Clear();
        }
        public void PrintUsedSOund()
        {
            // Debug.Log("used sound len" + usedSounds.Count);
        }
        public void SetSoundRound(int round)
        {
            soundRound = round;
        }
        public int GetSoundRound()
        {
            return soundRound;
        }
