...
namespace HyperCasual.Gameplay
{
    ...
    public class SequenceManager : AbstractSingleton<SequenceManager>
    {
        ...
        public void Initialize()
        {
            ...
            SetStartingLevel(0);
            SaveManager.Instance.LevelLength =  m_LevelStates.Count;
        }
        ...
        void OnMainMenuDisplayed()
        {
            ...
            //  spawn the player 
        //    if(m_LevelManagers[0]  != null){
        //       m_Player = Instantiate(m_LevelManagers[0] , new Vector3(2.0f, 0, 0), Quaternion.identity);
        //       PlayerController.Instance.AdjustSpeed(-20);
        //       m_Player.transform.localRotation = Quaternion.Euler(0,180,0);
        //       m_Player.transform.localScale = new Vector3(10, 10,10);
        //     //   m_Player.transform.localScale = Vector3(2, 2, 2);
        //     } 
        }
        ...
        void OnWinScreenDisplayed(IState currentLevel)
        {
            ...
            if (currentLevelIndex == levelProgress && currentLevelIndex < m_LevelStates.Count - 1)
                ...
                PlayFabManager.Instance.SendLeaderboard (levelProgress + 1);
        }
