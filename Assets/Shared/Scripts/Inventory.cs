...
namespace HyperCasual.Runner
{
    ...
    public class Inventory : AbstractSingleton<Inventory>
    {
        ...
        void Start()
        {
            ...
            m_MainMenu = UIManager.Instance.GetView<MainMenu>();

            m_CurrentLevel = LevelManager.Instance.LevelDefinition.LevelNum;
            m_Hud.CurrentLevel = m_CurrentLevel;
            m_levelProgress = SaveManager.Instance.LevelProgress;

            // Debug.Log("staring inventory");
        } 
        ...
        void OnGoldPicked()
        {
            ...
            {
                if(m_CurrentLevel > m_levelProgress)
                {
        ...
        {
            m_CurrentLevel = LevelManager.Instance.LevelDefinition.LevelNum;
            m_LevelCompleteScreen.ShowComlpetedLevel = m_CurrentLevel;
            m_levelProgress = SaveManager.Instance.LevelProgress;

            m_LevelCompleteScreen.TempGoldValue = m_TempGold;
            m_TotalGold += m_TempGold;
            m_LevelCompleteScreen.TotalGoldValue = m_TotalGold;

            m_TempGold = 0;
            m_MainMenu.GoldValue = m_TotalGold;
        ...
        void OnLose()
        {
            ...
            m_TempXp = 0f;
            SaveManager.Instance.XP = m_TotalXp;
            SaveManager.Instance.Currency -= 10;
        }
